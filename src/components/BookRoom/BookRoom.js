...
const BookRoom = () => {
    ...
    return (
        ...
        {/* Spinner */}
        <div className={loading ? "grid grid-cols-2 gap-8 mt-12 visible" : "hidden"}>
        ...
        <div>
            ...
            {success && <p className="text-white bg-green-500 py-2 px-3 mb-6 w-6/12 mx-auto rounded">{success}</p>}
            {error && <p className="text-white bg-red-500 py-2 px-3 mb-6 w-6/12 mx-auto rounded">{error}</p>}
